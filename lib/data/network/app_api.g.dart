...
class _AppServiceClient implements AppServiceClient {
  ...
  @override
  Future<Either<Failure , List<DrinksResponse>>> fetchDrink(String categoryType) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'c': categoryType};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<List<DrinksResponse>>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
  ...
  @override
  Future<Either<Failure, DrinkDetailsListResponse>>  fetchDrinkDetails(String drinkId) async {
    const _extra = <String, dynamic>{};
